...
class OrderOnWayPage extends StatelessWidget {
  ...
  Widget build(BuildContext context){
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.white,
        title: const TextFrave(text: 'Orders On Way'),
        centerTitle: true,
        elevation: 0,
        leadingWidth: 80,
        leading: InkWell(
    ...
    return ( listOrdersDelivery.length != 0 ) 
      ...
      : Column(
        ...
        children: [
          ...
          const TextFrave(text: 'Without Orders on way', color: ColorsFrave.primaryColor, fontWeight: FontWeight.w500, fontSize: 21)
        ],
      );
  }
}